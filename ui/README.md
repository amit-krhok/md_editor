...
- 📝 **Milkdown + GFM** — Markdown editing that doesn’t hate tables _as much_ as plain text does
...
Stack highlights: **Next.js (App Router)**, **MobX**, **Tailwind**, **TypeScript** — so your bundle is _modern_ and your types are _sometimes_ honest.
...
Built with **Next.js** and friends; their licenses apply. Any rough edges in the UI are _artisanal_.
